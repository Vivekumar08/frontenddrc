...
const Admission_Grievence_comm = () => {
  ...
  const fetchdata = async () => {
    const response = await fetch(
      "https://drc-server.onrender.com/Admission_Grievance_comm"
    );
  ...
  const del = async (id) => {
    console.log(id);
    const response = await fetch(
      `https://drc-server.onrender.com/deleteAdmission_Grievance_comm/${id}`,
      {
        method: "DELETE",
      }
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (link.trim() !== "" && caption.trim() !== "") {
        ...
        setErrMsg("");
        await axios.post(
          `https://drc-server.onrender.com/Admission_Grievance_comm_add`,
          formData,
          {
            headers: {
  ...
  const handleSubmit1 = async (e) => {
    ...
    const response = await fetch(
      "https://drc-server.onrender.com/Admission_Grievance_comm_add_link",
      {
        method: "POST",
        headers: {
...
export default Admission_Grievence_comm;
