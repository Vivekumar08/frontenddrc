...
const Student_feepayment = () => {
  ...
  const fetchdata = async () => {
    const response = await fetch("https://drc-server.onrender.com/StudentZone_Feepayment");
  ...
  const del = async (id) => {
    ...
    const response = await fetch(
      `https://drc-server.onrender.com/delete_StudentZone_Feepayment/${id}`,
      {
        method: "DELETE",
      }
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (link.trim() !== "" && caption.trim() !== "") {
        ...
        setErrMsg("");
        await axios.post(
          `https://drc-server.onrender.com/StudentZone_Feepayment_add`,
          formData,
          {
            headers: {
  ...
  const handleSubmit1 = async (e) => {
    ...
    const response = await fetch(
      "https://drc-server.onrender.com/StudentZone_Feepayment_add_link",
      {
        method: "POST",
        headers: {
          ...
          <div className="main flex-col ">
            <table className=" text-xs md:text-base  w-80 h-40  ml-1 md:table-fixed xl:ml-60  md:ml-32 md:w-[420px] lg:ml-44 sm:w-[480px] lg:w-[550px] xl:w-[750px] md:h-[180px] mt-1 ">
              <tr className="h-20 text-lg">
                ...
                <th className="text-lg w-[25%]">File</th>
