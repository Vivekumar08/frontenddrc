...
const Stud_Feedback = () => {
  ...
  const fetchdata = async () => {
    const response = await fetch("https://drc-server.onrender.com/Studfeedback");
  ...
  const del = async (id) => {
    ...
    const response = await fetch(
      `https://drc-server.onrender.com/deletestudfeedback/${id}`,
      {
        method: "DELETE",
        // headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://drc-server.onrender.com/StudentZone_feedback", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
