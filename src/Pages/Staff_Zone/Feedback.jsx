...
const Feedback = () => {
  ...
  const fetchdata = async () => {
    const response = await fetch("https://drc-server.onrender.com/feedback");
  ...
  const del = async (id) => {
    ...
    const response = await fetch(
      `https://drc-server.onrender.com/deletefeedback/${id}`,
      {
        method: "DELETE",
        // headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://drc-server.onrender.com/StaffZone_feedback", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
