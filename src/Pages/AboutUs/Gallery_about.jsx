...
function Gallery_about() {
  ...
  const fetchdata = async () => {
    const response = await fetch("https://drc-server.onrender.com/About_Gallery");
  ...
  const del = async (id) => {
    console.log(id);
    const response = await fetch(`https://drc-server.onrender.com/delete_Gallery_About/${id}`, {
      method: "DELETE",
    });
    const data = await response.json();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (file) {
        ...
        setErrMsg("");
        await axios.post(`https://drc-server.onrender.com/Gallery_About_add`, formData, {
          headers: {
