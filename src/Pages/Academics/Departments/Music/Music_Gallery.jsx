...
function Music_Gallery() {
  ...
  const fetchdata = async () => {
    const response = await fetch("/Music_Photo_Gallery");
  ...
  const del = async (id) => {
    console.log(id);
    const response = await fetch(`/delete_Music_Photo_Gallery/${id}`, {
      method: "DELETE",
    });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (file) {
        ...
        setErrMsg("");
        await axios.post(`/Music_Photo_Gallery_add`, formData, {
          headers: {
