...
const Bio_faculty = () => {
  ...
  const fetchdata = async () => {
    const response = await fetch("https://drc-server.onrender.com/bio_faculty");
  ...
  const del = async (id) => {
    ...
    const response = await fetch(
      `https://drc-server.onrender.com/delete_bio_faculty/${id}`,
      {
        method: "POST",
      }
    );
  ...
  const handleSubmit_cv = async (id, pdf) => {
    ...
    try {
      ...
      if (pdf) {
        await axios.post(
          `https://drc-server.onrender.com/bio_faculty_cv_upload/${id}`,
          {
            file: pdf,
          },
          {
      ...
      if (link.trim() !== "" && caption.trim() !== "") {
        if (imag) {
          ...
          const data = await axios.post(
            `https://drc-server.onrender.com/bio_faculty_file_upload`,
