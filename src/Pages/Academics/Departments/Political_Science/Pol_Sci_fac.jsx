...
import Political_Science_fac_data from "./Political_Science_fac_data";
import Political_Science_fac_data_sup from "./Political_Science_fac_data_sup";
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 ml-5 lg:grid-cols-3 xl:grid-cols-4 w-full mt-5 mb-5">
            {data1 &&
              data1.map((curElem) => {
                ...
                return (
                  <>
                    <Political_Science_fac_data_sup
                      key={_id}
                      id={_id}
                      title={title}
                      description={description}
