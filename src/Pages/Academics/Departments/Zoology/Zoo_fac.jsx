...
import Zoology_fac_data from "./Zoology_fac_data";
import Zoology_fac_data_sup from "./Zoology_fac_data_sup";
                ...
                <div className="mb-3">
                  ...
                  >
                    ...
                    <option
                      ...
                      className="p-2 text-lg acctive:text-white  block px-4 py-2 "
                    >
                      Superannuated / Former Faculty Faculty
                    </option>
                  </select>
                </div>
