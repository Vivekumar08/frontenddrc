...
function Events() {
  ...
  const fetchdata = async () => {
    const response = await fetch("https://drc-server.onrender.com/Eco_Events");
  ...
  const handleSubmit_file = async (id, pdf) => {
    try {
      if (pdf) {
        await axios.post(
          `https://drc-server.onrender.com/Eco_Events_file_add/${id}`,
          {
            file: pdf,
          },
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (caption.trim() !== "") {
        ...
        await axios.post(
          `https://drc-server.onrender.com/Eco_Events_add`,
