...
import Hinbanner from "../Hindi/Hindibanner";
import Hindi from "../../../../Components/DepartSIde/Hindi";
// import "./stl.css";

function Hin_Gallery() {
  ...
  const fetchdata = async () => {
    const response = await fetch(
      "https://drc-server.onrender.com/Hin_Photo_Gallery"
    );
  ...
  const del = async (id) => {
    console.log(id);
    const response = await fetch(
      `https://drc-server.onrender.com/delete_Hin_Photo_Gallery/${id}`,
      {
        method: "DELETE",
      }
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (file) {
        ...
        setErrMsg("");
        await axios.post(
          `https://drc-server.onrender.com/Hin_Photo_Gallery_add`,
          formData,
          {
            headers: {
